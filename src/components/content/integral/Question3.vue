            ...
            <b-card no-body>
                <b-tabs class="nav-fill" card v-model="tabIndex">
                    ...
                    <b-tab title="Conteúdo Teórico" active>
                        <h4>Substituição por Partes</h4>
                        <video width="30%" height="15%" controls>
                            <source src="../../../assets/Videos/integral-q3.webm" type="video/mp4">
...
export default {
  ...
  methods: {
    ...
    updateFormula: function () {
        ...
        this.formula = '$$\\int{ln(x)dx}$$'
        this.formula5 = '$$x+c$$'
        this.formula3 = '$$xln(x)-x+c$$'
        this.formula4 = '$$ln(2x)+c$$'
        this.formula2 = '$$2ln(x)+c$$'
        this.formula6 = '$$\\int{x\\over{\\sqrt{x+1}}}dx$$'
        this.formula8 = '$$2x\\sqrt{x+1}-{4\\sqrt{(x+1)^3}\\over{3}}+c$$'
        this.formula7 = '$${4\\sqrt{(x+1)^3}\\over{3}}+c$$'
        this.formula9 = '$$2x\\sqrt{x+1}+{4\\sqrt{(x+1)^3}}+c$$'
        this.formula10 = '$$4\\sqrt{(x+1)^3}+c$$'
      })
    },    
    trocaTab(){
        this.tabIndex++;
